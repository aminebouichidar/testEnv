...
<!-- Mirrored from themezhub.net/veshm-demo/veshm/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Apr 2023 17:33:59 GMT -->
<head>
		<meta charset="utf-8">
    ...
    <body>
        ...
        <div id="main-wrapper">
							...
							<ul class="nav-menu nav-menu-social align-to-right">
								@guest
									<li class="list-buttons border">
										<a href="JavaScript:Void(0);" data-bs-toggle="modal" data-bs-target="#login"><i class="fas fa-sign-in-alt me-2"></i>{{ __('Login') }}</a>
									</li>
									@if (Route::has('register'))
										<li class="list-buttons ms-2">
											<a href="{{ route('login') }}"><i class="fas fa-user-alt me-2"></i>{{ __('Register') }}</a>
										</li>
									@endif
								@else
									<li>
			...
			<!-- ============================ Page Title Start================================== -->
			<div class="page-title" style="background:#181823 url({{ asset('img/page-titles.png') }}) no-repeat;">
				<div class="container">
					<div class="row">
